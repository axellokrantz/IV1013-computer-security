...
public class StreamCipher {
    ...
    public static void main(String[] args){
        ...
        MyRandom rnd = sc.validateSeed(args[0]);
    ...
    private void encryptOrDecrypt(MyRandom rnd){
        try{
            int i = this.bufferInput.read();
            while(i != -1){
                this.bufferOutput.write((i ^ rnd.nextInt(8))); 
    ...
    private void validateOutputFile(String file){
        try{
    ...
    private MyRandom validateSeed(String string){
        try{
